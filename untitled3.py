...
Original file is located at
    https://colab.research.google.com/drive/1wShUisUXCebgfZDgypwd4fmj7I1gPtl-
"""
...
# Clase de Nodo
class Node:
    def __init__(self, value, children=None):  # <-- __init__ con doble _
        self.value = value
        self.children = children or []  # <-- corregido self.children

    def is_terminal_node(self):  # <-- añadidos dos puntos :
